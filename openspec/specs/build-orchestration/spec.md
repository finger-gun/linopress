...
Define the main build flow that takes a SiteSpec and orchestrates the full pipeline: provision runtime, install WordPress, configure plugins, generate theme, create content, validate, self-heal, and export. This is the top-level capability that ties all tools and skills together into a deterministic, end-to-end site creation process.
