...
- [x] 2.5 Introduce analyze → plan → apply phases with explicit tool usage and JSON outputs
- [x] 2.6 Require at least one write during apply or mark update as failed
- [x] 2.7 Add deterministic fallback edits for template-driven homepages (theme.json / templates)
...
- [x] 3.4 Use control-flow middleware to manage update pipeline and review loops
...
- [x] 4.3 Swap console logs to Sisu logger for update pipeline events
